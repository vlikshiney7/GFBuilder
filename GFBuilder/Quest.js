...
4687|L90.神廟偵查行動|90|1|18|異次元‧赤色山脊|If_CharLevel >= 88|add_appellation 8867
...
4955|L15.少女的祈禱|100|1|18|節慶|If_CharLevel >= 15|add_appellation 8891
4958|L15.大鬧王城|100|1|2|節慶|If_CharLevel >= 15|add_appellation 8892
4960|L15.男孩蛻變成男人|100|1|18|節慶|If_CharLevel >= 15|add_appellation 8893
4963|L15.無名之火的真相|100|1|2|節慶|If_CharLevel >= 15|add_appellation 8894
...
5016|L15.經典好味道|100|1|2|節慶|If_CharLevel >= 15|add_appellation 8906
5024|L15.與安娜的約定|100|1|2|節慶|If_CharLevel >= 15|add_appellation 8908
5025|L15.狐妖的祝福|100|1|2|精靈之森|If_CharLevel >= 15|add_appellation 8909
5032|L15.神秘的隱藏料理|100|1|2|節慶|If_CharLevel >= 15|add_appellation 8910
5039|L15.聖誕夜的溫暖|100|1|2|節慶|If_CharLevel >= 15|add_appellation 8911
5058|L70.混沌之地的征服者|100|1|18|混沌之地|If_CharLevel >= 70:If_CheckRebirthCount >= 1|add_appellation 8914
5078|L15.玩命快遞|100|1|2|節慶|If_CharLevel >= 15|add_appellation 8915
5080|L15.杰克與魔豆|100|1|2|遺產半島|If_CharLevel >= 15|add_appellation 8916
5083|L15.野豬剋星|100|1|2|節慶|If_CharLevel >= 15|add_appellation 8917
5105|L15.神抽王不是這麼好當的|100|1|2|15|節慶|If_CharLevel >= 15|add_appellation 8918
5114|L15.稀世珍寶的收藏家|100|1|2|節慶|If_CharLevel >= 15|add_appellation 8919
5224|L15慶典真有趣|100|1|2|節慶|If_CharLevel >= 15|add_appellation 8922
5235|L15.勇敢面對仙女的勇者|102|1|2|節慶|If_CharLevel >= 15|add_appellation 8923
5239|L15.命名之日的感動|100|1|2|節慶|If_CharLevel >= 15|add_appellation 8924
5240|L15.猩猩觀察|100|1|2|節慶|If_CharLevel >= 15|add_appellation 8925
5285|L15.平定粽子之亂|100|1|2|節慶||add_appellation 8928
5291|L80.冰與火之歌|100|1|2|寒焰峽關|If_CharLevel >= 80|add_appellation 8929
5307|L85.職業進階：操縱空間的挑戰|90|1|11|85|角色|If_CharLevel >= 85:If_Class 56 |add_appellation 8930:change_class 58
...
5988|L15.只是隻青蛙不是王子|100|1|2|虛空碎塊|If_CharLevel >= 15|add_appellation 8953
5993|L15.新年好運到！|100|1|2|15|節慶|If_CharLevel >= 15|add_appellation 8955
5997|L15.實琴大師的戀愛講座|100|1|2|15|節慶|If_CharLevel >= 15|add_appellation 8957
6203|海外新服100獎勵任務|100|1|19|一般任務|If_CharLevel >= 6|add_appellation 8976
6204|海外新服世界樹獎勵任務|100|1|19|一般任務|If_CharLevel >= 6|add_appellation 8977
6212|L15.冬夜因你而暖 |100|1|2|節慶|If_CharLevel >= 15|add_appellation 8979
