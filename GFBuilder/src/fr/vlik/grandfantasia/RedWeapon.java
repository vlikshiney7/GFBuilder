...
public class RedWeapon extends Weapon {
	...
	public RedWeapon(RedWeapon redWeapon) {
		super(redWeapon.getName(), redWeapon.getGrades(), redWeapon.getLvl(), redWeapon.getQuality(), redWeapon.isEnchantable(),
				redWeapon.getType(), redWeapon.isUniqueEquip(), redWeapon.isReinca(), null, redWeapon.getEffects(), redWeapon.getBonusXP());
		
		this.img = redWeapon.getIcon();
