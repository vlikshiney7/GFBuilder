...
public class LoaderPearlEnchantment {
	
	static PearlEnchantment[] getPearlEnchantment() {
		return new PearlEnchantment[] {
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "Lapin spirituel"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "Sage monarque"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "Lumière Sacrée"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "De l'Ombre"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "Nature"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "Foudre"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "Feu"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "Glace"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "Vache sanglante"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "Tigre arcanique"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "Inébranlable"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "Ours géant"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "Plume divine"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "Molosse arcanique"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "Lion arcanique"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "Molosse enragé"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "Seigneur Lion"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "Vantardise folle"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "Ours de guerre"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "Guépard"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "Singe écarlate"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
						new Effect(TypeEffect.MEN, false, 1),
					},
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "Tortue ténébreuse"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "Tortue maléfique"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "De Force"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "De Vitalité"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "D'Intelligence"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "De Volonté"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "D'Agilité"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "Antilope véloce"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "Contrôle"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "Débordement"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "Divinité"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "Force inébranlable"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "Sagesse inébranlable"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "Agilité inébranlable"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "Force contrôlée"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "Sagesse contrôlée"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
			...
			new PearlEnchantment(new HashMap<Language, String>() {{ put(Language.FR, "Agilité contrôlée"); put(Language.EN, ""); }},
				new Calculable[][] {
					new Calculable[] {
