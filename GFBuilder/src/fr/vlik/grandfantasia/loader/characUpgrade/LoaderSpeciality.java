...
public class LoaderSpeciality {
	...
	static Speciality[] getClass0() {
		return new Speciality[] {
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Force Frénétique"); put(Language.EN, ""); }}, 45, "0-0", new Calculable[] {
			...
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Tatouage Ardent"); put(Language.EN, ""); }}, 45, "0-5", new Calculable[] {
				new Effect(TypeEffect.Feu, false, 3),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Détection de Défaut"); put(Language.EN, ""); }}, 60, "0-6", new Calculable[] {
			...
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Volonté Tenace"); put(Language.EN, ""); }}, 60, "0-8", new Calculable[] {
				new Effect(TypeEffect.RTCCP, false, 2),
				new Effect(TypeEffect.RTCCM, false, 2),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Forme Rapide"); put(Language.EN, ""); }}, 60, "0-9", new Calculable[] {
				new Effect(TypeEffect.DegDuo, false, 1.5),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Carrure de Fer"); put(Language.EN, ""); }}, 75, "0-10", new Calculable[] {
				new Effect(TypeEffect.DefP, true, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Peau Lumineuse"); put(Language.EN, ""); }}, 75, "0-11", new Calculable[] {
				new Effect(TypeEffect.DefM, true, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Ombre Sanguinaire"); put(Language.EN, ""); }}, 75, "0-12", new Calculable[] {
				new Effect(TypeEffect.ESQ, false, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Figure de Proue"); put(Language.EN, ""); }}, 75, "0-13", new Calculable[] {
				new Effect(TypeEffect.Parade, false, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Exploration du Cerveau"); put(Language.EN, ""); }}, 75, "0-14", new Calculable[] {
			...
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Endurance"); put(Language.EN, ""); }}, 91, "0-16", new Calculable[] {
				new Effect(TypeEffect.RDCCP, false, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "La réponse"); put(Language.EN, ""); }}, 91, "0-17", new Calculable[] {
				new Effect(TypeEffect.VitAtkDuo, false, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Abus de faiblesse"); put(Language.EN, ""); }}, 91, "0-18", new Calculable[] {
				new Effect(TypeEffect.DCCP, false, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Bain de sang"); put(Language.EN, ""); }}, 91, "0-19", new Calculable[] {
	...
	static Speciality[] getClass6() {
		return new Speciality[] {
			...
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Chamana de Vide"); put(Language.EN, ""); }}, 75, "6-11", new Calculable[] {
				new Effect(TypeEffect.DefP, true, 1),
	...
	static Speciality[] getClass8() {
		return new Speciality[] {
			...
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Coeur d'Acier"); put(Language.EN, ""); }}, 75, "8-10", new Calculable[] {
				new Effect(TypeEffect.PV, true, 2),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Armure de Coeur"); put(Language.EN, ""); }}, 75, "8-11", new Calculable[] {
				new Effect(TypeEffect.DefP, true, 1.5),
			}),
	...
	static Speciality[] getClass9() {
		return new Speciality[] {
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, ""); put(Language.EN, ""); }}, 45, "9-0", new Calculable[] {
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, ""); put(Language.EN, ""); }}, 45, "9-1", new Calculable[] {
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, ""); put(Language.EN, ""); }}, 45, "9-2", new Calculable[] {
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, ""); put(Language.EN, ""); }}, 45, "9-3", new Calculable[] {
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, ""); put(Language.EN, ""); }}, 45, "9-4", new Calculable[] {
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, ""); put(Language.EN, ""); }}, 45, "9-5", new Calculable[] {
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, ""); put(Language.EN, ""); }}, 60, "9-6", new Calculable[] {
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, ""); put(Language.EN, ""); }}, 60, "9-7", new Calculable[] {
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, ""); put(Language.EN, ""); }}, 60, "9-8", new Calculable[] {
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, ""); put(Language.EN, ""); }}, 60, "9-9", new Calculable[] {
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, ""); put(Language.EN, ""); }}, 75, "9-10", new Calculable[] {
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, ""); put(Language.EN, ""); }}, 75, "9-11", new Calculable[] {
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, ""); put(Language.EN, ""); }}, 75, "9-12", new Calculable[] {
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, ""); put(Language.EN, ""); }}, 75, "9-13", new Calculable[] {
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, ""); put(Language.EN, ""); }}, 75, "9-14", new Calculable[] {
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, ""); put(Language.EN, ""); }}, 75, "9-15", new Calculable[] {
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, ""); put(Language.EN, ""); }}, 91, "9-16", new Calculable[] {
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, ""); put(Language.EN, ""); }}, 91, "9-17", new Calculable[] {
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, ""); put(Language.EN, ""); }}, 91, "9-18", new Calculable[] {
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, ""); put(Language.EN, ""); }}, 91, "9-19", new Calculable[] {
			}),
		};
	}
