...
public class LoaderSpeciality {
	...
	static Speciality[] getClass0() {
		return new Speciality[] {
			...
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Force frénétique ultime"); put(Language.EN, ""); }}, 100, "0-21", new Calculable[] {
			...
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Spécialiste du bouclier"); put(Language.EN, ""); }}, 100, "0-24", new Calculable[] {
				new Effect(TypeEffect.ShieldDefP, false, 1),
				new Effect(TypeEffect.ShieldDefM, false, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Armure solide"); put(Language.EN, ""); }}, 100, "0-25", new Calculable[] {
	...
	static Speciality[] getClass1() {
		return new Speciality[] {
			...
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Réflexes travaillés"); put(Language.EN, ""); }}, 100, "1-22", new Calculable[] {
				new Effect(TypeEffect.AGI, false, 12),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Auto-défense"); put(Language.EN, ""); }}, 100, "1-23", new Calculable[] {
				new Effect(TypeEffect.RParade, false, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Barrière de défense"); put(Language.EN, ""); }}, 100, "1-24", new Calculable[] {
				new Effect(TypeEffect.ShieldDefP, false, 1.5),
				new Effect(TypeEffect.ShieldDefM, false, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Entraînement à l'armure lourde"); put(Language.EN, ""); }}, 100, "1-25", new Calculable[] {
	...
	static Speciality[] getClass2() {
		return new Speciality[] {
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Ruée"); put(Language.EN, ""); }}, 45, "2-0", new Calculable[] {
				new Effect(TypeEffect.Depla, false, 1.3),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Maître des Bêtes"); put(Language.EN, ""); }}, 45, "2-1", new Calculable[] {
				new Proc(1, Activation.Phys, new Calculable[] {
					new Effect(TypeEffect.DegBete, false, 50),
				}),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Souffle du Vent"); put(Language.EN, ""); }}, 45, "2-2", new Calculable[] {
				new Effect(TypeEffect.AGI, false, 9),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Tireur Expérimenté"); put(Language.EN, ""); }}, 45, "2-3", new Calculable[] {
				new Effect(TypeEffect.ToucherD, false, 1.5),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Survivant des Terres Enneigées"); put(Language.EN, ""); }}, 45, "2-4", new Calculable[] {
				new Effect(TypeEffect.Glace, false, 3),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Maître dans l'Usage des Flèches"); put(Language.EN, ""); }}, 45, "2-5", new Calculable[] {
				new Effect(TypeEffect.DegArc, false, 1.5),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Voyage dans la Forêt"); put(Language.EN, ""); }}, 60, "2-6", new Calculable[] {
				new Effect(TypeEffect.ESQ, false, 2),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Spécialiste Poudre à Canon"); put(Language.EN, ""); }}, 60, "2-7", new Calculable[] {
				new Effect(TypeEffect.TCCGun, false, 0.5),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Sniper"); put(Language.EN, ""); }}, 60, "2-8", new Calculable[] {
				new Effect(TypeEffect.DCCArc, false, 3),
				new Effect(TypeEffect.DCCGun, false, 3),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Souffle"); put(Language.EN, ""); }}, 60, "2-9", new Calculable[] {
				new Effect(TypeEffect.MEN, false, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Robustesse Physique"); put(Language.EN, ""); }}, 75, "2-10", new Calculable[] {
				new Effect(TypeEffect.PV, true, 1),
				new Effect(TypeEffect.VIT, false, 3),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Force Naturelle"); put(Language.EN, ""); }}, 75, "2-11", new Calculable[] {
				new Effect(TypeEffect.DefP, true, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Tatouage Magique"); put(Language.EN, ""); }}, 75, "2-12", new Calculable[] {
				new Effect(TypeEffect.DefM, true, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Visée Zen"); put(Language.EN, ""); }}, 75, "2-13", new Calculable[] {
				new Effect(TypeEffect.TCCArc, false, 1),
				new Effect(TypeEffect.TCCGun, false, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Combat Rapproché"); put(Language.EN, ""); }}, 75, "2-14", new Calculable[] {
				new Effect(TypeEffect.Atk, true, 2.5),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Ballistics Research"); put(Language.EN, ""); }}, 75, "2-15", new Calculable[] {
				new Effect(TypeEffect.AtkD, true, 1.5),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Tir tranchant"); put(Language.EN, ""); }}, 91, "2-16", new Calculable[] {
				new Effect(TypeEffect.TCCP, false, 0.5),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Capacité vitale"); put(Language.EN, ""); }}, 91, "2-17", new Calculable[] {
				new Effect(TypeEffect.PM, true, 1),
			}),
			...
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Flexibilité extrême"); put(Language.EN, ""); }}, 100, "2-22", new Calculable[] {
				new Effect(TypeEffect.AGI, true, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Chasse sans fin"); put(Language.EN, ""); }}, 100, "2-23", new Calculable[] {
				new Proc(1, Activation.Standard, new Calculable[] {
					new MultipleHit(TypeMultipleHit.Double, 3),
				}),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Armure à pointes"); put(Language.EN, ""); }}, 100, "2-24", new Calculable[] {
				new Proc(1, Activation.Attacked, new Calculable[] {
					new MultipleHit(TypeMultipleHit.ReflectP, 2),
				}),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Ténacité"); put(Language.EN, ""); }}, 100, "2-25", new Calculable[] {
				new Effect(TypeEffect.ReducStdP, false, 1),
				new Effect(TypeEffect.ReducStdD, false, 1),
				new Effect(TypeEffect.ReducSkillP, false, 1),
			}),
	...
	static Speciality[] getClass3() {
		return new Speciality[] {
			...
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Épées d'ombre et de lumière"); put(Language.EN, ""); }}, 100, "3-20", new Calculable[] {
			...
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Réflexe rapide"); put(Language.EN, ""); }}, 100, "3-22", new Calculable[] {
				new Effect(TypeEffect.AGI, true, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Assaut explosif"); put(Language.EN, ""); }}, 100, "3-23", new Calculable[] {
				new Proc(1, Activation.Standard, new Calculable[] {
					new MultipleHit(TypeMultipleHit.Double, 3),
				}),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Piège raffiné"); put(Language.EN, ""); }}, 100, "3-24", new Calculable[] {
				new Proc(1, Activation.Attacked, new Calculable[] {
					new MultipleHit(TypeMultipleHit.ReflectP, 2),
				}),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Formation mentale"); put(Language.EN, ""); }}, 100, "3-25", new Calculable[] {
				new Effect(TypeEffect.ReducSkillM, false, 1),
			}),
		};
	}
	...
	static Speciality[] getClass4() {
		return new Speciality[] {
			...
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Larmes d'adieu"); put(Language.EN, ""); }}, 100, "4-22", new Calculable[] {
				new Effect(TypeEffect.HealD, false, 1.5),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Armure cristalline"); put(Language.EN, ""); }}, 100, "4-23", new Calculable[] {
				new Effect(TypeEffect.ReducPeneP, false, 1.5),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Cape Runique"); put(Language.EN, ""); }}, 100, "4-24", new Calculable[] {
				new Effect(TypeEffect.ReducPeneM, false, 1.5),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Bouclier des Psaumes Sacrés"); put(Language.EN, ""); }}, 100, "4-25", new Calculable[] {
				new Effect(TypeEffect.ShieldDefP, false, 1),
	...
	static Speciality[] getClass5() {
		return new Speciality[] {
			...
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Foi indéfectible"); put(Language.EN, ""); }}, 100, "5-20", new Calculable[] {
				new Effect(TypeEffect.VIT, 3, TypeEffect.VOL, TypeCalcul.CONVERTALL),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Pouvoir sacré"); put(Language.EN, ""); }}, 100, "5-21", new Calculable[] {
				new Effect(TypeEffect.INT, true, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Explosion mentale"); put(Language.EN, ""); }}, 100, "5-22", new Calculable[] {
				new Effect(TypeEffect.VOL, false, 12),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Défense de Lumière Sacrée"); put(Language.EN, ""); }}, 100, "5-23", new Calculable[] {
				new Effect(TypeEffect.ReducPeneP, false, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Pluie protectrice"); put(Language.EN, ""); }}, 100, "5-24", new Calculable[] {
				new Effect(TypeEffect.ReducPeneM, false, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Psalmodie"); put(Language.EN, ""); }}, 100, "5-25", new Calculable[] {
				new Effect(TypeEffect.CostComp, false, -5),
			}),
		};
	}
	...
	static Speciality[] getClass6() {
		return new Speciality[] {
			...
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Sceptre magique"); put(Language.EN, ""); }}, 100, "6-24", new Calculable[] {
			...
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Protection de l'Archimage"); put(Language.EN, ""); }}, 100, "6-25", new Calculable[] {
				new Effect(TypeEffect.ReducPeneM, false, 1),
			}),
		};
	}
	...
	static Speciality[] getClass7() {
		return new Speciality[] {
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Connaissance en Magie Noire"); put(Language.EN, ""); }}, 45, "7-0", new Calculable[] {
				new Effect(TypeEffect.AtkM, true, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Transfert de Menace"); put(Language.EN, ""); }}, 45, "7-1", new Calculable[] {
				new Effect(TypeEffect.MEN, false, -1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Rituel de l'Âme Sanguinaire"); put(Language.EN, ""); }}, 45, "7-2", new Calculable[] {
				new Effect(TypeEffect.PV, true, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Eclatement de l'Esprit"); put(Language.EN, ""); }}, 45, "7-3", new Calculable[] {
				new Effect(TypeEffect.TCCM, false, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Corrosion du Métal"); put(Language.EN, ""); }}, 45, "7-4", new Calculable[] {
				new Proc(1, Activation.Mag, new Calculable[] {
					new Effect(TypeEffect.DegMeca, false, 50),
				}),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Esprit Maléfique"); put(Language.EN, ""); }}, 45, "7-5", new Calculable[] {
				new Effect(TypeEffect.Ombre, false, 3),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Coeur de la Sorcière"); put(Language.EN, ""); }}, 60, "7-6", new Calculable[] {
				new Effect(TypeEffect.INT, false, 9),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Envoûtement Rapide"); put(Language.EN, ""); }}, 60, "7-7", new Calculable[] {
				new Effect(TypeEffect.VitComp, false, 1.7),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Renforcement Physique"); put(Language.EN, ""); }}, 60, "7-8", new Calculable[] {
				new Effect(TypeEffect.RTCCP, false, 3),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Brume Fantôme Noire"); put(Language.EN, ""); }}, 60, "7-9", new Calculable[] {
				new Effect(TypeEffect.ESQ, false, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Coeur de Sorcière"); put(Language.EN, ""); }}, 75, "7-10", new Calculable[] {
				new Effect(TypeEffect.PM, true, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Protection des Os"); put(Language.EN, ""); }}, 75, "7-11", new Calculable[] {
				new Effect(TypeEffect.DefP, true, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Barrière Spirituelle"); put(Language.EN, ""); }}, 75, "7-12", new Calculable[] {
				new Effect(TypeEffect.DefM, true, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Attaque Psychique"); put(Language.EN, ""); }}, 75, "7-13", new Calculable[] {
				new Effect(TypeEffect.Toucher, false, 2),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Protection de la Chair"); put(Language.EN, ""); }}, 75, "7-14", new Calculable[] {
				new Effect(TypeEffect.ReducStdP, false, 1),
				new Effect(TypeEffect.ReducStdD, false, 1),
				new Effect(TypeEffect.ReducSkillP, false, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Invocation interdite"); put(Language.EN, ""); }}, 75, "7-15", new Calculable[] {
				new Effect(TypeEffect.DCCM, false, 3),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Sang du démon"); put(Language.EN, ""); }}, 91, "7-16", new Calculable[] {
				new Effect(TypeEffect.VIT, false, 9),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Malédiction des ombres"); put(Language.EN, ""); }}, 91, "7-17", new Calculable[] {
				new Effect(TypeEffect.VOL, false, 9),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Dissipation d'énergie"); put(Language.EN, ""); }}, 91, "7-18", new Calculable[] {
				new Effect(TypeEffect.RDCCM, false, 3),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Dissolution de Brume noire"); put(Language.EN, ""); }}, 91, "7-19", new Calculable[] {
				new Effect(TypeEffect.ReducStdP, false, 1, WeaponType.BATON),
				new Effect(TypeEffect.ReducStdD, false, 1, WeaponType.BATON),
				new Effect(TypeEffect.ReducSkillP, false, 1, WeaponType.BATON),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Malédiction des ténèbres"); put(Language.EN, ""); }}, 100, "7-20", new Calculable[] {
				new Effect(TypeEffect.INT, 0.2, TypeEffect.PM, TypeCalcul.CONVERTBASE),
			}),
			...
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Consommation maléfique"); put(Language.EN, ""); }}, 100, "7-22", new Calculable[] {
				new Effect(TypeEffect.INT, true, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Sorcellerie Améliorée"); put(Language.EN, ""); }}, 100, "7-23", new Calculable[] {
				new Effect(TypeEffect.VOL, true, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Obscure Magie"); put(Language.EN, ""); }}, 100, "7-24", new Calculable[] {
				new Effect(TypeEffect.AtkM, true, 1, WeaponType.BATON),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Gardiens de l'aura maléfique"); put(Language.EN, ""); }}, 100, "7-25", new Calculable[] {
	...
	static Speciality[] getClass8() {
		return new Speciality[] {
			...
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Amplification neutronique"); put(Language.EN, ""); }}, 100, "8-22", new Calculable[] {
				new Effect(TypeEffect.VOL, true, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Énergie Améliorée"); put(Language.EN, ""); }}, 100, "8-23", new Calculable[] {
				new Effect(TypeEffect.PM, true, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Protection externe"); put(Language.EN, ""); }}, 100, "8-24", new Calculable[] {
				new Effect(TypeEffect.RDCCP, false, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Vol à basse altitude"); put(Language.EN, ""); }}, 100, "8-25", new Calculable[] {
				new Effect(TypeEffect.MEN, false, -1),
			}),
		};
	}
	...
	static Speciality[] getClass9() {
		return new Speciality[] {
			...
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Équilibrage de l'équipement"); put(Language.EN, ""); }}, 100, "9-21", new Calculable[] {
				new Effect(TypeEffect.AGI, true, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Choc éducatif"); put(Language.EN, ""); }}, 100, "9-22", new Calculable[] {
				new Effect(TypeEffect.VOL, true, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Économiser ses forces"); put(Language.EN, ""); }}, 100, "9-23", new Calculable[] {
				new Effect(TypeEffect.PV, true, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Recherche magique"); put(Language.EN, ""); }}, 100, "9-24", new Calculable[] {
				new Effect(TypeEffect.RDCCM, false, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Écailles miroir"); put(Language.EN, ""); }}, 100, "9-25", new Calculable[] {
	...
	static Speciality[] getClass10() {
		return new Speciality[] {
			...
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Croissance cristalline"); put(Language.EN, ""); }}, 100, "10-22", new Calculable[] {
				new Effect(TypeEffect.VIT, true, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Sacrifice du Cristal magique"); put(Language.EN, ""); }}, 100, "10-23", new Calculable[] {
				new Effect(TypeEffect.DegSkillM, false, 1.2),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Cercle cristallin"); put(Language.EN, ""); }}, 100, "10-24", new Calculable[] {
				new Effect(TypeEffect.RDCCM, false, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Tatouage de sang maudit"); put(Language.EN, ""); }}, 100, "10-25", new Calculable[] {
				new Proc(1, Activation.Attacked, new Calculable[] {
	...
	static Speciality[] getClass11() {
		return new Speciality[] {
			...
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Maîtrise de la Lumière divine"); put(Language.EN, ""); }}, 100, "11-21", new Calculable[] {
				new Effect(TypeEffect.AGI, true, 1),
			}),
			new Speciality(new HashMap<Language, String>() {{ put(Language.FR, "Polyvalence de la poupée vaudou"); put(Language.EN, ""); }}, 100, "11-22", new Calculable[] {
				new Effect(TypeEffect.VOL, true, 1),
			}),
