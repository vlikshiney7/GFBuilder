...
public class Tools {
	...
	public static final double[] coefRedFortifMax = { 1, 1.02, 1.04, 1.06, 1.08, 1.10, 1.12, 1.14, 1.16, 1.18, 1.20, 1.23, 1.26, 1.29, 1.32, 1.35, 1.38, 1.41, 1.44, 1.47, 1.50, 1.54, 1.58, 1.62, 1.66, 1.70, 1.74, 1.78, 1.82, 1.86, 1.90, 1.96, 2.02, 2.08, 2.14, 2.20, 2.26, 2.32, 2.38, 2.44, 2.50, 2.58, 2.66, 2.74, 2.82, 2.90, 3.00, 3.10, 3.20, 3.30, 3.40 };
