...
public class Bullet {
	...
	public Bullet(String name, int lvl, int quality, String path, ArrayList<Effect> effects) {
		this.name = name;
		this.lvl = lvl;
	...
	private BufferedImage setIcon(String path) {
		...
		try {
			object = ImageIO.read(MainFrame.class.getResource("/fr/vlik/gfbuilder/resources/bullet/" + path));
		} catch (IOException e) {
