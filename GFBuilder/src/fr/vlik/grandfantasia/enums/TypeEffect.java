...
public enum TypeEffect {
	...
	RTCCM("Réduction Taux Coup Critique Magique", "", "Red Tx Crt Mg", "", -1, true, Consts.EffectColor[0]),
	...
	ReducAtkD("Réduction d'Attaque Distance", "", "Reduc Atq Dist", "", -1, true, Consts.EffectColor[0]),
	ReducAtkM("Réduction d'Attaque Magique", "", "Reduc Atq Mag", "", -1, true, Consts.EffectColor[0]),
	
	DegAtkD("Dégât d'Attaque Distance", "", "Dg Atq Dist", "", -1, true, Consts.EffectColor[0]),
	RDegAtkD("Réduction de Dégât d'Attaque Distance", "", "Red Dg Dist", "", -1, true, Consts.EffectColor[0]),
	
	DegSacre("Dégât Sacré", "", "Deg Sacre", "", -1, true, Consts.EffectColor[0]),
	DegOmbre("Dégât Ombre", "", "Deg Ombre", "", -1, true, Consts.EffectColor[0]),
	DegFoudre("Dégât Foudre", "", "Deg Foudre", "", -1, true, Consts.EffectColor[0]),
	DegFeu("Dégât Feu", "", "Deg Feu", "", -1, true, Consts.EffectColor[0]),
	...
	DegStd2Ep("Dégât Standard à l'Épée 2 Main", "", "Deg Std Ep 2M", "", -1, true, Consts.EffectColor[0]),
	DegStd2Ma("Dégât Standard au Maillet 2 Main", "", "Deg Std Ma 2M", "", -1, true, Consts.EffectColor[0]),
	DegStd2Ha("Dégât Standard à la Hache 2 Main", "", "Deg Std Ha 2M", "", -1, true, Consts.EffectColor[0]),
	DegStdArc("Dégât Standard à l'Arc", "", "Deg Std Arc", "", -1, true, Consts.EffectColor[0]),
	...
	DegHumaP("Dégât Physique sur Humanoïde", "", "Deg Phys Huma", "", -1, true, Consts.EffectColor[0]),
	DegElemP("Dégât Physique sur Élémentaire", "", "Deg Phys Elem", "", -1, true, Consts.EffectColor[0]),
	DegMecaP("Dégât Physique sur Mécanique", "", "Deg Phys Meca", "", -1, true, Consts.EffectColor[0]),
	DegMortP("Dégât Physique sur Mort-Vivant", "", "Deg Phys Mort", "", -1, true, Consts.EffectColor[0]),
	DegDemonP("Dégât Physique sur Démon", "", "Deg Phys Demon", "", -1, true, Consts.EffectColor[0]),
	DegBeteM("Dégât Magique sur Bête", "", "Deg Mag Bete", "", -1, true, Consts.EffectColor[0]),
	DegPlanteM("Dégât Magique sur Plante", "", "Deg Mag Plante", "", -1, true, Consts.EffectColor[0]),
	DegHumaM("Dégât Magique sur Humanoïde", "", "Deg Mag Huma", "", -1, true, Consts.EffectColor[0]),
	DegElemM("Dégât Magique sur Élémentaire", "", "Deg Mag Elem", "", -1, true, Consts.EffectColor[0]),
	DegMecaM("Dégât Magique sur Mécanique", "", "Deg Mag Meca", "", -1, true, Consts.EffectColor[0]),
	DegMortM("Dégât Magique sur Mort-Vivant", "", "Deg Mag Mort", "", -1, true, Consts.EffectColor[0]),
	DegDemonM("Dégât Magique sur Démon", "", "Deg Mag Demon", "", -1, true, Consts.EffectColor[0]),
	
	IntComp("Interruption de Compétence", "", "Inter Comp", "", -1, true, Consts.EffectColor[0]),
	CostComp("Coût de Compétence", "", "Coût Comp", "", -1, true, Consts.EffectColor[0]),
	ReloadComp("Rechargement de Compétence", "", "Recharge Comp", "", -1, false, Consts.EffectColor[0]),
	Parade("Parade", "", "Parade", "", -1, true, Consts.EffectColor[0]),
