...
var enchant = document.getElementsByClassName('color-grey')[0];
enchant = enchant.innerHTML.match("Combinable") ? true : false;
...
console.log(name + "/" + idClasses + "/" + lvl + "/" + color + "/" + enchant + "/false/" + reinca + "/" + count + ",0,0/" + effects);